...
\begin{itemize}
  ...
  \item Initialization of $\alpha$ et $\beta$: there were initialized randomly, with $\alpha > 0$.
  \item Computation of $\alpha$ much simpler under the exchangeable Dirichlet distribution assumption.
  \item Parameters: choice of $k$, number of iterations so that the E-step and M-step converge.
\end{itemize}
\end{block}
\end{column}
