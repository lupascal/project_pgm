...
def maximise_log_likelihood(corpus, list_var_dirich, list_var_multinom, 
                            voc_size, convergence_threshold = 1e-5):
    """
